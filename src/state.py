...
from src.persistence import (
    ...
    load_rigged_scratch, load_rigged_steal, load_gambler_streak, load_quote_log, load_chess_games, load_tax, load_curse,
...
active_taxes: dict = load_tax()             # user_id → tax data
