...
- Optional dailies channel (`!settings dailies-channel`) — a self-cleaning channel with a single "Claim your dailies" embed; reacting 🪙 instantly claims the daily reward and all scratchoffs, results auto-delete after 5 minutes, and the claim reactions reset at 5am CT
