...
def test_steal_reason_uses_victim_display_name_and_amount():
    assert format_steal_reason("Alice", 1500) == "Tried to steal 1,500 coins from Alice"
...
def test_reasons_fit_in_varchar_255():
    ...
    long_name = "x" * 64
    assert len(format_steal_reason(long_name, 999_999_999_999)) < 255
